...
def download_button(label, data, file_name):
    ...
    href = f'<a href="data:application/octet-stream;base64,{b64}" download="{file_name}" class="btn btn-outline-primary">{label}</a>'
...
with col2:
    ...
    download_button("Download Resume", PDFbyte, resume_file.name)
